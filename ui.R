...
shinyUI(
    navbarPage("Natural Language Prediction", inverse = FALSE, collapsible = FALSE, 
                   tabPanel("Prediction", (includeScript("Google_Analytics.js")),
                            ...
                            fluidRow(
                                sidebarPanel(width=3,
                                    ...
                                    helpText("4. Click on ",code("Update Word Cloud"), " to get a wordcloud for the prediction", style="color:#428ee8"),
                                    hr(),
                                    helpText(h5("Note:")),
                                    ...
                                    ## a(img(src = "GitHub-Mark.png", height = 30, width = 30),href="https://github.com/bengapple/Developing-Data_Products"),
                                    ## a(img(src = "linkedin.png", height = 26, width = 26),href="https://www.linkedin.com/in/bengapple"),
                                    ## a(img(src = "/gmail.jpeg", height = 30, width = 30),href="mailto:bengapple@gmail.com"),
                                    br()
                                ),
                                mainPanel(
                                    column(5,
                                    ...
                                    p('More details of the prediction algorithm and source codes', 
                                      ...
                                      'can be found at', a("SwiftKey-Natural-language.",href="https://github.com/bengapple/Developing-Data_Products"))
                                    ),
                                    column(5,
                   ...
                   tabPanel("Model/Algorithm",
                            sidebarLayout(
                                sidebarPanel(width=3,
                                    ...
                                    hr(),
                                    helpText(h5("Note:")),
                                    helpText("For more information, you can go to", code("Documents tab"), "in the navigation bar
                                             to read the Mid-Point and Finale report of this data product."),
                                    hr(),
                                    h6("This App is built for:"),
                                    a("Data Science Capstone (SwiftKey)", href="https://www.coursera.org/course/dsscapstone"),
                                    p("class started on March 9th 2015"),
                                ...
                                mainPanel(
                                    tabsetPanel(type="tabs",
                                                tabPanel("Predictive Model TEST",                                                      
                                                         h3("Predictive Model Establishment"),hr(),
                                                         h4("Clean the training dataset"),
                                                         p("The dataset was cleaned by using the tokenization and ngramify,
                                                           functions. These functions are able to help users tokenize and ngramify
                                                           the text data in an automatic way and allow user to split large datasets into a bunch of
                                                           user defined number of small ones in order to reduce the processing time and avoid the 
                                                           memory limits issues."),
                                   ...
                                   and the joint probability of all unobserved species. The last three words of users\' input sentence will be extracted first and used
                                                           ...
                                                           the Finale predictions will be chosen accordingly by the frequency and n-grams of the model.' ),                                                         
                                                         hr(),
                              ...
                              tabPanel("Finale Report",
                                       sidebarLayout(
                                           sidebarPanel(width=3,
                                                        ...
                                                        helpText("1. A brief explanation of the text preperation procedures", style="color:#428ee8"),
                                                        helpText("2. A description of the algorithm used to make the prediction", style="color:#428ee8"),
                                                        helpText("3. Description of app and instructions of how it functions", style="color:#428ee8"),
                                                        helpText("4. Description of the experience of using this app", style="color:#428ee8"),
                                                        hr(),
                                                        h6("This App is built for:"),
                                                        a("Data Science Capstone (SwiftKey)", href="https://www.coursera.org/course/dsscapstone"),
                                           ...
                                           mainPanel(width=9,
                                               column(8,
                                                      a(img(src = "slides_1.png"),href="http://rpubs.com/bengapple/70831"),hr(),
                                                      a(img(src = "slides_2.png"),href="http://rpubs.com/bengapple/70831"),hr(),
                                                      a(img(src = "slides_3.png"),href="http://rpubs.com/bengapple/70831"),hr(),
                                                      a(img(src = "slides_4.png"),href="http://rpubs.com/bengapple/70831"),hr(),
                                                      a(img(src = "slides_5.png"),href="http://rpubs.com/bengapple/70831"),hr()
                                               ),
                                               column(4,
                                                      ...
                                                      a("SwiftKey-presentation-rpubs", href="http://rpubs.com/bengapple/70831")
                                               )
                                           )
                                       )
                              )
